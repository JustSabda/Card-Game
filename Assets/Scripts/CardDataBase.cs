...
public class CardDataBase : MonoBehaviour
{
    ...
    private void Awake()
    {
        ...
        //Enemy
        cardList.Add(new Card(9, "Prajurit Tombak", 3, 3, "None", Resources.Load<Sprite>("Prajurit Tombak"), Resources.Load<Sprite>("Enemy Prajurit Tombak Ico"), 0, 0, 0, 1, false, false));
        cardList.Add(new Card(10, "Prajurit Pedang", 2, 2, "None", Resources.Load<Sprite>("Prajurit Pedang"), Resources.Load<Sprite>("Enemy Prajurit Pedang Ico"), 0, 0, 0, 1, false, false));
        cardList.Add(new Card(11, "Benteng Proteksi", 3, 4, "None", Resources.Load<Sprite>("Benteng Pertahanan"), Resources.Load<Sprite>("Enemy Benteng Pertahanan Ico"), 0, 0, 0, 0, false, false));
        cardList.Add(new Card(12, "Prajurit Kilat", 2, 1, "None", Resources.Load<Sprite>("Prajurit Kilat"), Resources.Load<Sprite>("Enemy Prajurit Kilat Ico"), 0, 0, 0, 2, false, false));
        cardList.Add(new Card(13, "Prajurit Es", 2, 1, "None", Resources.Load<Sprite>("Prajurit Es"), Resources.Load<Sprite>("Enemy Prajurit Es Ico"), 0, 0, 0, 1, true, false));
        cardList.Add(new Card(14, "Ken Arok", 7, 5, "None", Resources.Load<Sprite>("Ken Arok"), Resources.Load<Sprite>("Enemy Ken Arok Ico"), 0, 0, 0, 1, false, false));
        cardList.Add(new Card(15, "Kertanegara", 5, 3, "None", Resources.Load<Sprite>("Kertanegara"), Resources.Load<Sprite>("Enemy Kertanegara Ico"), 0, 0, 0, 1, false, false));
        cardList.Add(new Card(16, "Siliwangi", 5, 1, "None", Resources.Load<Sprite>("Siliwangi"), Resources.Load<Sprite>("Enemy Siliwangi Ico"), 0, 0, 0, 2, false, true));
        cardList.Add(new Card(17, "Kian Santang", 6, 4, "None", Resources.Load<Sprite>("Kian Santang"), Resources.Load<Sprite>("Enemy Kian Santang Ico"), 0, 0, 0, 1, false, false));
    }
}
